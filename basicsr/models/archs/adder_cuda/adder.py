...
from basicsr.models.archs.adder_cuda.quantize import quantize, quantize_grad, QuantMeasure, calculate_qparams

from torch.utils.cpp_extension import load

adder_cuda = load(
  'adder_cuda', ['basicsr/models/archs/adder_cuda/adder_cuda.cpp','basicsr/models/archs/adder_cuda/adder_cuda_kernel.cu'], verbose=True)
...
class Adder2DFunction(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        # return grad_input, grad_weight * 10, None, None, None, None, None, None, None

        return grad_input, grad_weight * 100, None, None, None, None, None, None, None
